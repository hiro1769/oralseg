...
parser.add_argument('--model_name', default="pointnetpp", type=str, help = "model name. list: tsegnet | tgnet_fps/tgnet_bdl | pointnet | pointnetpp | dgcnn | pointtransformer")
parser.add_argument('--config_path', default="train_configs/pointnetpp.py", type=str, help = "train config file path.")
parser.add_argument('--experiment_name', default="test_82300", type=str, help = "experiment name.")
