...
parser.add_argument('--mesh_path', default="/home/repos/ToothGroupNetwork/data/3D_scans_per_patient_obj_files/0EJBIPTC/0EJBIPTC_lower.obj", type=str)
parser.add_argument('--gt_json_path', default="/home/repos/ToothGroupNetwork/data/ground-truth_labels_instances/0EJBIPTC/0EJBIPTC_lower.json" ,type=str)
parser.add_argument('--pred_json_path', type=str, default="/home/repos/ToothGroupNetwork/test_results/dgcnn/0EJBIPTC_lower.json")
